...
def request_handler(url: str, method: str, data = None) -> httpx.Response:
    if method == 'GET':
...
async def async_request_handler(url: str, method: str, data: None = None) -> httpx.Response:
    if method == 'GET':
